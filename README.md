...
the Vetted team was posed with a unique problem. Prime Digital Academy has a program that allows students who've been active in the military to attend Prime for free. With that does come a lot of paperwork and before all this data was kept on a spreadsheet. Our goal was to help organize that data and streamline the process of updating a student's information in regards to the status of them attending prime.
...
1. After installations are complete begin by registering an account 
2. Once user is logged in there will be a table of all the students in the database 
3. User can chose to scroll through the table as is or, can use the dropdown to sort by student type
4. User can also update a single student's info by clicking the view button associated with the student 
...
A very special thank you to all who worked on this project: Jonathon Baxendell, Holly Drazenovich, Aubree Herrion, and Alex Suedkamp. 
